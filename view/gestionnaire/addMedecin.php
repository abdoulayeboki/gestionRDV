...
session_start();
 ...
 $tab=array();
  ...
  $nbrMedecin=$gestionMedecin->countMedecin();
?>
<!DOCTYPE html>  
<html lang="fr">
    <head>
...
<a href="#"><button class="btn btn-danger btn-md"  >Deconexion</button></a>
  ...
  <div class="row">
    ...
    <div class=" col-lg-s9 col-md-8 col-sm-8 col-xs-8 ">
      ...
      <form method="post" action="../../controller/addMedecin.php" class="needs-validation offset-lg-2 col-lg-8 col-md-8 col-sm-8 col-xs-8 ">
      <div class="form-group ">
      <label for="matricule">Matricule</label>
      <input type="text" class="form-control" id="matricule"  readonly="true" name="matricule"
      value="<?php $n= $nbrMedecin['nbr']+1;  printf("M-%05d",$n) ?>"/>
    </div>
