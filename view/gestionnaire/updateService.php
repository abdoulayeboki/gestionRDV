...
<html lang="fr">
    ...
    <div class=" col-lg-s9 col-md-8 col-sm-8 col-xs-8 ">
      ...
      <form method="post" action="../../controller/gestionnaire/updateService.php?id=<?php echo $idService; ?>"
       class="needs-validation offset-lg-2 col-lg-8 col-md-8 col-sm-8 col-xs-8 ">
 
    <div class="form-group ">
      <label for="nomService">Nom du service</label>
      <input type="text" class="form-control" id="nomService" required name="nomService"
