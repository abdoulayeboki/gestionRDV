...
<html lang="fr">
    ...
    <div class=" col-lg-9 col-md-8 col-sm-8 col-xs-8 ">
      ...
      <table class="table table-condensed table-responsive table-hover table-striped ">
       ...
       <tbody>
         <?php foreach($mesRdv as $m) { ?>
          <tr>
            <td><?php echo $m["motifRdv"] ?></td>
            <td><?php echo $m["heureDebut"] ?></td>
            <td><?php echo $m["heureFin"] ?></td>
            <td><?php echo $m["dateRdv"] ?></td>
            <td><?php echo $m["nomPatient"]." ".$m['prenomPatient'] ;?></td>
            <td><?php echo $m["matriculePatient"];?></td>
            <td><?php echo $m["idSecretaire"];?></td>
          </tr>
         <?php } ?>
       </tbody>
      </table>
